...
The data recorded and calculated from the cantilever, aluminum simply-supported, and the steel simply-supported experiments are shown in Tables 1, 2, and 3 respectively. A plot of the calculated and experimental cantilever beam deflections are shown in Figure 3. It can be seen that the experimental data closely matches the calculated data. The data also shows that the beam tends to deflect more as the distance from the beam support is increased.
\bigskip
\bigskip
